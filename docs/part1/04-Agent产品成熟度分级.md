...
**Q1.** L1"单轮工具调用"的核心特征是什么？
A. 完全没有模型参与　B. 模型判断调用哪个工具，调用一次拿到结果就结束　C. 模型自主规划多步　D. 多个模型协作

**Q2.** 文中提到"多步但路径固定的工作流编排"属于谱系的哪个家族？
A. L0家族　B. L1家族　C. L2家族　D. L3家族

**Q3.** 升级到 L3 多智能体协作之前，最容易踩的坑是什么？
A. 成本太低　B. L2 都没做扎实就跳到 L3，指望多个Agent互相纠错弥补单点能力不足　C. 模型选错了　D. 没有用框架

**Q4.** L2 自主规划循环必须配套的护栏包括？
A. 只需要更强的模型　B. 最大步数限制、关键动作二次确认、结果可追溯校验　C. 不需要任何护栏　D. 只需要日志

**Q5.** 判断要不要升级到下一级，文中强调的原则是什么？
A. 觉得应该更高级就升　B. 已验证当前级别真的不够用，且算过边际收益与边际成本的账　C. 老板要求就升　D. 竞品用了就升
