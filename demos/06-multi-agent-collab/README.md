...
> 对应课程 [Part5 第18章 毕业设计capstone项目](../../docs/part5/18-毕业设计Pitch.md)，以及 [Part1 第04章 L3多智能体协作](../../docs/part1/04-Agent产品成熟度分级.md) 的可运行实现。
...
跑通之后，回到 [Part5 第18章](../../docs/part5/18-毕业设计Pitch.md) 的毕业作品部分，尝试用课程学到的框架逐条回答：**为什么这个任务需要两个角色分工而不是一个 Agent 独立完成？协调者的委派逻辑是否合理？如果一直不通过审查，除了轮数上限还应该加什么护栏？**
